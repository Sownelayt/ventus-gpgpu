...
$(VLIB_SRC_V) parameters.json &: $(VLIB_SRC_SCALA)
	...
	find $(VLIB_SRC_V_DIR) -maxdepth 1 -type f \( -name "*.sv" -o -name "*.fir" -o -name "*.anno.json" \) -delete
	cd .. && ./mill -i ventus[6.4.0].runMain top.paramToJson
	cd .. && ./mill -i ventus[6.4.0].runMain circt.stage.ChiselMain --module top.GPGPU_SimTop --target chirrtl --target-dir sim-verilator/$(VLIB_SRC_V_DIR)/
