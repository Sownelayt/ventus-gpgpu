...
object Instructions {
  ...
  def CP_ASYNC_COPYSIZE  = BitPat("b00000?????????????000?????1000010")
  def CP_ASYNC_BULK      = BitPat("b00000?????????????001?????1000010")
  def CP_ASYNC_TENSOR    = BitPat("b00000?????????????010?????1000010")
  def CP_ASYNC_BULK_S2G  = BitPat("b00000?????????????011?????1000010")
  def CP_ASYNC_TENSOR_S2G = BitPat("b00000?????????????100?????1000010")
  def PREFETCH_TENSORMAP = BitPat("b00000?????????????101?????1000010")
  def CP_ASYNC_FENCE     = BitPat("b00000?????????????110?????1000010")
}
